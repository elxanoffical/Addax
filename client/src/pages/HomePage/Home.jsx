    ...
    <div className="section">
      ...
      <div className="hero-wrapper">
        <div className="blur">
          ...
          <h1>The Best <span id='digital'>Digital</span> Experience</h1>
      ...
      <div className='welcome-addax' >
        <div className="container">
          <div className="section-title">
            ...
            <div className="txt">
              <span>We Are Creative</span>
              <h1>Welcome to <span>Addax</span></h1>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            </div>
          </div>
          <div className="row">
      ...
      <div className="footer">
        ...
        <p>Copyright Addax All Rights Reserved by <span>EnvyTheme</span></p>
      </div>
